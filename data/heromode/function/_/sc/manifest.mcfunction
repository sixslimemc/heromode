#> heromode:_/sc/manifest
# @ MANIFEST

data remove storage slimecore:in manifest.pack

data modify storage slimecore:in manifest.pack.pack_id set value "heromode"
...
data modify storage slimecore:in manifest.pack.url set value "https://github.com/sixslimemc/heromode/releases/download/v0.1.0/sixslime.heromode.0.1.0.zip"

data modify storage slimecore:in manifest.pack.display.name set value "Hero Mode"
data modify storage slimecore:in manifest.pack.display.summary set value "A thrown together difficulty increase for select players."
...
data modify storage slimecore:in manifest.pack.display.links.info set value "https://github.com/sixslimemc/heromode"
data modify storage slimecore:in manifest.pack.display.links.versions set value "https://github.com/sixslimemc/heromode/releases"
